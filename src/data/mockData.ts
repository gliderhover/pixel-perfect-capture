...
export const mockZones: MapZone[] = [
  ...
  { id: "z-nhv-pre2", type: "pressure", name: "Hospital Bend Pressure Spot", lat: 41.3053, lng: -72.9377, benefit: "+Confidence" },
  { id: "z-nhv-pre3", type: "pressure", name: "Long Wharf Clutch Run", lat: 41.2918, lng: -72.9149, benefit: "+Confidence" },
  { id: "z-nhv-pre4", type: "pressure", name: "Wharfside Final-Minute Test", lat: 41.2947, lng: -72.9108, benefit: "+Confidence" },
  { id: "z-nhv-mis2", type: "mission", name: "Lighthouse Point Lens Route", lat: 41.2827, lng: -72.8879, benefit: "Camera XP" },
  { id: "z-nhv-mis3", type: "mission", name: "Downtown Street Capture Loop", lat: 41.3076, lng: -72.9272, benefit: "Camera XP" },
  { id: "z-nhv-mis4", type: "mission", name: "East Rock Lookout Capture", lat: 41.3262, lng: -72.9107, benefit: "Camera XP" },
  // New York metro
